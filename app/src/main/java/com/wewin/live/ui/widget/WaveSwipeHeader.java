...
public class WaveSwipeHeader extends InternalAbstract implements RefreshHeader {
    ...
    protected WaveSwipeHeader.ProgressAnimationImageView mCircleView;
    ...
    public WaveSwipeHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        thisGroup.addView(mCircleView = new WaveSwipeHeader.ProgressAnimationImageView(context));
...
//            onPulling(0.99f, DensityUtil.dp2px(99), DensityUtil.dp2px(100), DensityUtil.dp2px(100));
    ...
    public void onMoving(boolean isDragging, float percent, int offset, int height, int maxDragHeight) {
        if (isDragging) {
            ...
            float finalBounds = (firstBounds - WaveSwipeHeader.VERTICAL_DRAG_THRESHOLD.SECOND.val) / 5;
