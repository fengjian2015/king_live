...
public class DefaultAnimation1 implements ICustomerAnimation {
    ...
    @Override
    public AnimatorSet giftEnterAnimation(final GiftAnimationLayout layout, final AbstractGiftViewHolder holder) {
    ...
    @Override
    public AnimatorSet giftExitAnimation(GiftAnimationLayout layout, final AbstractGiftViewHolder holder) {
        //向上渐变消失
        ObjectAnimator fadeAnimator1 = GiftAnimationUtils.createFadeAnimator(layout, 0, -100, 200, 0);
