...
public class DefaultAnimation2 implements ICustomerAnimation {
    ...
    public AnimatorSet giftEnterAnimation(final GiftAnimationLayout layout, AbstractGiftViewHolder holder) {
        //礼物飞入
        ObjectAnimator animator = GiftAnimationUtils.createTranslationXAnimator(layout, 1500, 0, 500, new DecelerateInterpolator());
    ...
    public AnimatorSet giftExitAnimation(final GiftAnimationLayout layout, AbstractGiftViewHolder holder) {
        ObjectAnimator animator1 = GiftAnimationUtils.createFadeAnimator(layout, 0, -50, 1.0f, 0.5f, 500, 0);
        ObjectAnimator animator2 = GiftAnimationUtils.createFadeAnimator(layout, -50, -100, 0.5f, 0f, 500, 0);
        // 复原
